...
module.exports.upload = async (req, res) => {
    ...
    const thumbnailUploadPath = path.join(__dirname, "../public/images/thumbnails/");
    const videoUploadPath = path.join(__dirname, "../media/videos/");
    const podcastUploadPath = path.join(__dirname, "../media/podcasts/");
