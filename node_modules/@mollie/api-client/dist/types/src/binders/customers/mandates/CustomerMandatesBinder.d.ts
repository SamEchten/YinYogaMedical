...
export default class CustomerMandatesBinder extends InnerBinder<MandateData, Mandate> {
     ...
     */
    all: CustomerMandatesBinder['page'];
    /**
     * Retrieve all mandates for the given `customerId`, ordered from newest to oldest.
     *
     * The results are paginated. See pagination for more information.
     ...
     * @see https://docs.mollie.com/reference/v2/mandates-api/list-mandates
     */
    list: CustomerMandatesBinder['page'];
    /**
     ...
     */
    cancel: CustomerMandatesBinder['revoke'];
    /**
     * Revoke a customer's mandate. You will no longer be able to charge the consumer's bank account or credit card with this mandate and all connected subscriptions will be canceled.
     *
     * @since 2.0.0
     ...
     * @see https://docs.mollie.com/reference/v2/mandates-api/revoke-mandate
     */
    delete: CustomerMandatesBinder['revoke'];
    /**
     ...
     */
    create(parameters: CreateParameters): Promise<Mandate>;
    create(parameters: CreateParameters, callback: Callback<Mandate>): void;
    /**
     ...
     */
    get(id: string, parameters: GetParameters): Promise<Mandate>;
    get(id: string, parameters: GetParameters, callback: Callback<Mandate>): void;
    /**
     * Retrieve all mandates for the given `customerId`, ordered from newest to oldest.
     *
     * The results are paginated. See pagination for more information.
     ...
     * @see https://docs.mollie.com/reference/v2/mandates-api/list-mandates
     */
    page(parameters: ListParameters): Promise<List<Mandate>>;
    page(parameters: ListParameters, callback: Callback<List<Mandate>>): void;
    /**
     * Retrieve all mandates for the given `customerId`, ordered from newest to oldest.
     *
     * The results are paginated. See pagination for more information.
     ...
     * @see https://docs.mollie.com/reference/v2/mandates-api/list-mandates
     */
    iterate(parameters: Omit<ListParameters, 'limit'>): import("../../../plumbing/HelpfulIterator").default<Mandate>;
    /**
     * Revoke a customer's mandate. You will no longer be able to charge the consumer's bank account or credit card with this mandate and all connected subscriptions will be canceled.
     *
     * @since 2.0.0
     * @see https://docs.mollie.com/reference/v2/mandates-api/revoke-mandate
     */
    revoke(id: string, parameters: RevokeParameters): Promise<true>;
    revoke(id: string, parameters: RevokeParameters, callback: Callback<true>): void;
}
