...
export default class PaymentCapturesBinder extends InnerBinder<CaptureData, Capture> {
     ...
     */
    all: PaymentCapturesBinder['page'];
    /**
     * Retrieve all captures for a certain payment.
     *
     * Captures are used for payments that have the *authorize-then-capture* flow. The only payment methods at the moment that have this flow are *Klarna Pay now*, *Klarna Pay later* and *Klarna Slice
     ...
     * @see https://docs.mollie.com/reference/v2/captures-api/list-captures
     */
    list: PaymentCapturesBinder['page'];
    /**
     ...
     */
    get(id: string, parameters: GetParameters): Promise<Capture>;
    get(id: string, parameters: GetParameters, callback: Callback<Capture>): void;
    /**
     * Retrieve all captures for a certain payment.
     *
     * Captures are used for payments that have the *authorize-then-capture* flow. The only payment methods at the moment that have this flow are *Klarna Pay now*, *Klarna Pay later* and *Klarna Slice
     ...
     * @see https://docs.mollie.com/reference/v2/captures-api/list-captures
     */
    page(parameters: ListParameters): Promise<List<Capture>>;
    page(parameters: ListParameters, callback: Callback<List<Capture>>): void;
    /**
     * Retrieve all captures for a certain payment.
     *
     * Captures are used for payments that have the *authorize-then-capture* flow. The only payment methods at the moment that have this flow are *Klarna Pay now*, *Klarna Pay later* and *Klarna Slice
     ...
     * @see https://docs.mollie.com/reference/v2/captures-api/list-captures
     */
    iterate(parameters: Omit<ListParameters, 'limit'>): import("../../../plumbing/HelpfulIterator").default<Capture>;
}
