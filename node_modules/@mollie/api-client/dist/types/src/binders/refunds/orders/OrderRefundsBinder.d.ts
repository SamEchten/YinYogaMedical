...
export declare function getPathSegments(orderId: string): string;
export default class OrderRefundsBinder extends InnerBinder<RefundData, Refund> {
     ...
     * @see https://docs.mollie.com/reference/v2/refunds-api/list-order-refunds
     */
    iterate(parameters: Omit<ListParameters, 'limit'>): import("../../../plumbing/HelpfulIterator").default<Refund>;
}
