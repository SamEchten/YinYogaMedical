...
export declare type CreateParameters = ContextParameters & Pick<ShipmentData, 'tracking'> & {
    /**
...
export declare type GetParameters = ContextParameters;
export declare type ListParameters = ContextParameters;
export declare type UpdateParameters = ContextParameters & PickRequired<ShipmentData, 'tracking'>;
export {};
