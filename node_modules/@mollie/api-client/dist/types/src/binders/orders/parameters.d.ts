...
export declare type CreateParameters = Pick<OrderData, 'amount' | 'orderNumber' | 'billingAddress' | 'webhookUrl' | 'locale' | 'metadata' | 'expiresAt'> & {
     ...
     */
    payment?: Pick<PaymentCreateParameters, 'applePayPaymentToken' | 'cardToken' | 'consumerAccount' | 'customerId' | 'customerReference' | 'issuer' | 'mandateId' | 'sequenceType' | 'voucherNumber' | 'voucherPin' | 'webhookUrl' | 'applicationFee'>;
    /**
...
export declare type UpdateParameters = PickOptional<OrderData, 'billingAddress' | 'shippingAddress' | 'redirectUrl' | 'webhookUrl'> & {
    orderNumber?: string;
    testmode?: boolean;
};
export declare type ListParameters = PaginationParameters & {
    profileId?: string;
    testmode?: boolean;
};
