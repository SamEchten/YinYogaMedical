...
export declare type UpdateParameters = ContextParameters & PickOptional<OrderLineData, 'name' | 'quantity' | 'unitPrice' | 'discountAmount' | 'sku' | 'totalAmount' | 'vatAmount' | 'vatRate'> & {
    /**
...
export declare type CancelParameters = ContextParameters & {
    /**
