...
export declare type MollieClient = ReturnType<typeof createMollieClient>;
...
import { CreateParameters as CustomerCreateParams, DeleteParameters as CustomerDeleteParams, GetParameters as CustomerGetParams, UpdateParameters as CustomerUpdateParams, ListParameters as CustomersListParams } from './binders/customers/parameters';
...
import { CreateParameters as MandateCreateParams, GetParameters as MandateGetParams, RevokeParameters as MandateRevokeParams, ListParameters as MandatesListParams } from './binders/customers/mandates/parameters';
...
import { CancelParameters as OrderCancelParams, CreateParameters as OrderCreateParams, GetParameters as OrderGetParams, UpdateParameters as OrderUpdateParams, ListParameters as OrdersListParams } from './binders/orders/parameters';
...
import { CancelParameters as PaymentCancelParams, CreateParameters as PaymentCreateParams, GetParameters as PaymentGetParams, ListParameters as PaymentsListParams } from './binders/payments/parameters';
...
import { CancelParameters as PaymentRefundCancelParams, CreateParameters as PaymentRefundCreateParams, GetParameters as PaymentRefundGetParams, ListParameters as PaymentRefundsListParams } from './binders/payments/refunds/parameters';
...
import { CreateParameters as ShipmentCreateParams, GetParameters as ShipmentGetParams, UpdateParameters as ShipmentUpdateParams, ListParameters as ShipmentsListParams } from './binders/orders/shipments/parameters';
...
import { CancelParameters as SubscriptionCancelParams, CreateParameters as SubscriptionCreateParams, GetParameters as SubscriptionGetParams, UpdateParameters as SubscriptionUpdateParams, ListParameters as SubscriptionsListParams } from './binders/customers/subscriptions/parameters';
