...
import OrderLine, { OrderLineData } from '../orderlines/OrderLine';
...
declare type Shipment = Seal<ShipmentData & {
    lines: OrderLine[];
}, ShipmentHelper>;
...
export declare function transform(networkClient: TransformingNetworkClient, input: ShipmentData): Shipment;
