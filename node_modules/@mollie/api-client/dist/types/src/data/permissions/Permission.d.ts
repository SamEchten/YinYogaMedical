...
declare type Permission = Seal<PermissionData, Helper<PermissionData, Permission>>;
export default Permission;
export declare type PermissionLinks = Links;
export declare function transform(networkClient: TransformingNetworkClient, input: PermissionData): Permission;
