...
declare type Customer = Seal<CustomerData, CustomerHelper>;
...
export declare function transform(networkClient: TransformingNetworkClient, input: CustomerData): Customer;
