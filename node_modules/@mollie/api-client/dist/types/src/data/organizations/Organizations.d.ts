...
declare type Organization = Seal<OrganizationData, Helper<OrganizationData, Organization>>;
export default Organization;
export declare type OrganizationLinks = Links;
export declare function transform(networkClient: TransformingNetworkClient, input: OrganizationData): Organization;
