...
export declare type CardFailureReason = 'authentication_abandoned' | 'authentication_failed' | 'authentication_required' | 'authentication_unavailable_acs' | 'card_declined' | 'card_expired' | 'inactive_card' | 'insufficient_funds' | 'invalid_cvv' | 'invalid_card_holder_name' | 'invalid_card_number' | 'invalid_card_type' | 'possible_fraud' | 'refused_by_issuer' | 'unknown_reason';
export declare type CardAudience = 'consumer' | 'business';
export declare type FeeRegion = 'american-express' | 'amex-intra-eea' | 'carte-bancaire' | 'intra-eu' | 'intra-eu-corporate' | 'domestic' | 'maestro' | 'other';
export declare enum SequenceType {
    oneoff = "oneoff",
    first = "first",
    recurring = "recurring"
}
export declare type MollieApiErrorLinks = Record<string, Url> & Links;
