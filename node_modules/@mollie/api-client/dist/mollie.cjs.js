...
function stringifyQuery(input) {
  ...
  return `?${querystring.stringify(entries.reduce((result, [key, value]) => {
...
class NetworkClient {
  constructor(_ref) {
    ...
    this.axiosInstance = axios__default["default"].create(_objectSpread2(_objectSpread2({}, axiosOptions), {}, {
      baseURL: apiEndpoint,
...
function convertToString(subject, tag, depth, options) {
  ...
  parts.push(util.inspect(Object.fromEntries(Object.entries(subject).filter(([key]) => stringRepresentationBlacklist.has(key) === false)), _objectSpread2(_objectSpread2({}, options), {}, {
    depth: 1,
    sorted: true
  })));
  return parts.join(' ');
...
exports.HistoricPaymentMethod = void 0;
...
exports.MethodImageSize = void 0;
...
function parseQueryInUrl(url$1) {
  return buildFromEntries(new url.URL(url$1).searchParams);
}
...
class OrderHelper extends Helper {
  ...
  getPayments() {
    ...
    return this.networkClient.get(`${pathSegment$a}/${this.id}`, {
      embed: [exports.OrderEmbed.payments]
...
class ProfileHelper extends Helper {
  ...
  isUnverified() {
    return this.status == exports.ProfileStatus.unverified;
  }
  /**
  ...
  isVerified() {
    return this.status == exports.ProfileStatus.verified;
  }
  /**
  ...
  isBlocked() {
    return this.status == exports.ProfileStatus.blocked;
  }
  /**
...
})(exports.OnboardingStatus || (exports.OnboardingStatus = {}));
...
class OnboardingHelper extends Helper {
  ...
  needsData() {
    return this.status == exports.OnboardingStatus.needsData;
  }
  /**
  ...
  isInReview() {
    return this.status == exports.OnboardingStatus.inReview;
  }
  /**
  ...
  isCompleted() {
    return this.status == exports.OnboardingStatus.completed;
  }
  /**
...
exports.CaptureEmbed = void 0;

(function (CaptureEmbed) {
  CaptureEmbed["payment"] = "payment";
})(exports.CaptureEmbed || (exports.CaptureEmbed = {}));
